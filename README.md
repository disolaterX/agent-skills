...
| [`unslop`](./unslop) | Cuts AI tells from any writing and adds human voice. Must always apply. |
...
npx skills add disolaterX/agent-skills --skill unslop
```
...
├── unslop/
│   └── SKILL.md          # cut AI tells, add human voice
└── README.md             # this file
```
